...
public class PagamentoQuitacaoModel implements Serializable {
	...
	private PagamentoParcelaModel parcela;
	...
	public PagamentoParcelaModel getParcela() {
		return parcela;
	}

	public void setParcela(PagamentoParcelaModel parcela) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PagamentoQuitacaoModel other = (PagamentoQuitacaoModel) obj;
		if (idQuitacao == null) {
