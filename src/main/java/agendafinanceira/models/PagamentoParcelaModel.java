...
public class PagamentoParcelaModel implements Serializable {
	...
	private List<PagamentoQuitacaoModel> pagamentos;
	...
	public List<PagamentoQuitacaoModel> getPagamentos() {
		return pagamentos;
	}

	public void setPagamentos(List<PagamentoQuitacaoModel> pagamentos) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PagamentoParcelaModel other = (PagamentoParcelaModel) obj;
		if (idParcela == null) {
